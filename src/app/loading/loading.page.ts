...
export class LoadingPage {
  ...
  initApp() {
    ...
    } else if (!this.loadingState.tasksLoaded) {
      this.loadTasks();
  ...
  loadTasks() {
    ...
    this.backendService.loadTaskClusters().subscribe(data => {
      this.model.taskClusters = data;
      this.loadingState.tasksLoaded = true;
      this.initApp();
    });
  }
