...
@Component({
    selector: 'garage-upgrade-info-modal',
    template: `
      <div class="ma-2 popover-scrollable" *ngIf="building">
        ...
        <div class="mt-2">Upgrade Garage to be able to upgrade vehicles and parts to higher levels.</div>
...
export class GarageUpgradeInfoModal {
