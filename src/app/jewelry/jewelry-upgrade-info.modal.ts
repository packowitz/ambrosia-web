...
@Component({
    selector: 'jewelry-upgrade-info-modal',
    template: `
      <div class="ma-2 popover-scrollable" *ngIf="building">
        <div class="flex-space-between">
          <strong>The Jewelry</strong>
          <ion-button size="small" fill="clear" color="dark" (click)="closeModal()">
            <ion-icon name="close"></ion-icon>
          </ion-button>
        </div>
        <div class="mt-2">Upgrade Jewelry to be able to merge jewels of higher levels.</div>
...
export class JewelryUpgradeInfoModal {
