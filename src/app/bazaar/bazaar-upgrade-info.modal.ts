...
@Component({
    selector: 'bazaar-upgrade-info-modal',
    template: `
      <div class="ma-2 popover-scrollable" *ngIf="building">
        <div class="flex-space-between">
          <strong>The Bazaar</strong>
          <ion-button size="small" fill="clear" color="dark" (click)="closeModal()">
            <ion-icon name="close"></ion-icon>
          </ion-button>
        </div>
        <div class="mt-2">Upgrade Bazaar to get access to restricted area and to get better deals.</div>
...
export class BazaarUpgradeInfoModal {
