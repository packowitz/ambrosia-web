...
@Component({
    selector: 'academy-upgrade-info-modal',
    template: `
      <div class="ma-2 popover-scrollable" *ngIf="building">
        ...
        <div class="mt-2">Upgrade Academy to be able to train and evolve heroes of higher levels.</div>
...
export class AcademyUpgradeInfoModal {
